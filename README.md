...
backend/equipment-data.json


Data persists across refreshes

React does not store permanent data

Backend JSON file is the single source of truth
...
Add equipment from UI

Open equipment-data.json
